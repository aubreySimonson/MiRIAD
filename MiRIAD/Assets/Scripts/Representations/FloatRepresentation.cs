...
/// <summary>
/// Abstract class which any representation that uses a float should use to initialize itself. 
...
public abstract class FloatRepresentation : AbstractRepresentation
{
    ...
    public abstract void RefreshDisplay(float newValue);
    public abstract void RefreshDisplay(string newValue);
}
